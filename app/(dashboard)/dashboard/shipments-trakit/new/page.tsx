...
import DocumentUploader, { DocumentUpload } from '@/components/docs/DocumentUploader';
    ...
    switch (step) {
      ...
      case 'details':
        ...
        if (!formData.arrivalDate) {
          newErrors.arrivalDate = 'Expected arrival date is required';
        } else {
        ...
        if ((formData.type === 'SEA' || formData.type === 'ROAD') && !formData.truck.trim()) {
          newErrors.truck = 'Truck number is required for sea or road shipments';
        }
        break;
     ...
     case 'documents':
      ...
      case 'review':
        ...
        const uploadedDocTypesReview = formData.documents.map(doc => doc.type);
  ...
  <div className="relative rounded-md shadow-sm">
    <Popover>
      ...
      <PopoverContent className="w-auto p-0" align="start">
       <Calendar
  mode="single"
  selected={formData.arrivalDate ? new Date(formData.arrivalDate) : new Date()}
  onSelect={(date) =>
...
/>
    ...
    {errors.arrivalDate && <p className="text-red-500 text-xs mt-1">{errors.arrivalDate}</p>}
              ...
              {(formData.type === 'ROAD' || formData.type === 'SEA') && (
                <div className="space-y-2">
                  ...
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <input
                      ...
                      className={`focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2 border ${errors.truck ? 'border-red-500' : ''}`}
        ...
        return (
          <div className="space-y-6 p-6">
            ...
            {errors.documents && (
              <div className="bg-red-50 rounded-md p-3 flex items-start">
                <Info className="h-5 w-5 text-red-500 mt-0.5 flex-shrink-0" />
                <p className="ml-3 text-sm text-red-700">{errors.documents}</p>
              </div>
            )}
            ...
            <DocumentUploader 
              ...
              requiredTypes={getRequiredDocumentTypes(formData.type)}
              maxDocuments={10}
            />
          </div>
        );
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-900">
                        {formData.type === 'SEA' ? 'Sea Freight' : formData.type === 'AIR' ? 'Air Freight' : 'Road Freight'}
                      </p>
                      <p className="text-sm text-gray-500 mt-1">
              ...
              <Card className="p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="space-y-3">
                  {getRequiredDocumentTypes(formData.type).map((docType) => {
                    ...
                    return (
                      <div key={docType} className={`flex items-center p-2 rounded-md ${uploaded ? 'bg-green-50' : ''}`}>
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex justify-between mb-8 p-4 bg-white rounded-lg shadow-sm">
          <Button
            ...
            className="flex items-center gap-2 px-6 py-2 border border-gray-300 text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <ArrowLeft size={16} />
            Back
          </Button>
