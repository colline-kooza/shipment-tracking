...
import { ArrowRight, Package, MapPin, Clock, Truck, TrainTrackIcon, Car } from "lucide-react"
    ...
    <div className="min-h-screen relative">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-[#0f2557]/90 backdrop-blur-xs"></div>
      </div>
            ...
            <div className="flex flex-col md:flex-row ">
              <div className="w-full md:w-1/2  md:mb-0 text-white md:ml-12  md:mt-10">
               ...
               <div className="flex gap-2">
                 <Link
                  href="/dashboard"
                  className="inline-flex items-center px-8 py-3 bg-white text-[#0f2557] hover:bg-[#4d82e5]/10 hover:text-white hover:border-white border border-transparent rounded-lg font-semibold transition duration-300 transform hover:translate-x-1 text-sm md:mb-0 mb-4"
                >
                  Go to Dashboard
                ...
                <Link
                  href="/track"
                  className="inline-flex items-center px-8 py-3 hover:bg-white hover:text-[#0f2557] bg-[#4d82e5]/10 text-white border-white border border-transparent rounded-lg font-semibold transition duration-300 transform hover:translate-x-1 text-sm md:mb-0 mb-4"
                >
                 Track
                ...
                <div className="relative w-full max-w-md">
                  ...
                  <div className="bg-white/10 backdrop-blur-xl rounded-xl p-8 shadow-2xl border border-white/20 text-white">
                    ...
                    <div className="space-y-9">
                      ...
                      <div className="pl-8">
                        <div className="border-l-2 border-dashed border-[#4d82e5] h-10u"></div>
                      </div>
                      ...
                      <div className="pl-8">
                        <div className="border-l-2 border-dashed border-gray-500/30 h-10u"></div>
                      </div>
