...
const faqs = [
  ...
  {
    question: "Is the starter kit being maintained regularly?",
    answer:
  ...
  },
  {
    ...
    answer:
      "If you encounter any bugs, you can report them through our GitHub issues or Whatsapp community. Our development team actively monitors these channels and typically responds within 24-48 hours. We prioritize bug fixes and regularly release updates to ensure the stability of the codebase.",
  },
  {
    question: "What do I get for my money?",
    answer:
      "Your purchase includes: Full source code access, Regular updates and improvements, Premium UI components, Authentication system, Payment integration, Email templates, Documentation, APIs, Database schema, Admin dashboard, and Customer support through our whatsapp community. You also get lifetime access to all future updates within the current major version.",
  },
  {
