...
interface FormData {
  ...
  billOfLadingNumber?: string // Added billOfLadingNumber
  container: string
  truck: string
...
const NewShipment: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    reference: "",
    airwayBillNumber: "",
    billOfLadingNumber: "", // Initialized billOfLadingNumber
    trackingNumber: "",
    origin: "",
    destination: "",
    arrivalDate: "",
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    const shipmentData = {
      ...
      billOfLadingNumber: formData.billOfLadingNumber || null, // Included billOfLadingNumber
        ...
        return (
          <div className="space-y-6 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <Input
                    ...
                    disabled
                    className="bg-gray-50 pl-10 cursor-not-allowed"
                  />
                </div>
              </div>
              ...
              {/* )} */}
              {/* Add Bill of Lading Number field here */}
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="arrivalDate">Expected Delivery Date *</Label>
                <div className="relative rounded-md shadow-sm">
                  <Popover>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      {formData.billOfLadingNumber && ( // Display billOfLadingNumber
                        <p className="text-sm text-gray-500">
